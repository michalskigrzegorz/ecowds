...
// START >>> CHAT
var fixme = document.querySelector('.ecowds-live-chat');
var fixmeTop = fixme.offsetTop;
window.addEventListener('scroll', function() {
  ...
  if (currentScroll >= fixmeTop) {
    ...
    fixme.style.display = 'none';
    // fixme.style.top = '0';    
    // fixme.style.left = '90vw';
  }
});
...
//   var fadeInTop = fadeIn.getBoundingClientRect().top;
//   var windowHeight = window.innerHeight;

//   if (fadeInTop < windowHeight) {
//     fadeIn.style.transition = 'opacity 5s, transform 5s';
